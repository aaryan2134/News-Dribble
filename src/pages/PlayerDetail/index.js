  ...
  return (
    <section className={styles.container}>
      <section className={styles.playersContainer}>
        ...
        <div>
          <br></br>
          <a href="https://nft-mint-indol.vercel.app/mint?imgURL=https://ak-static.cms.nba.com/wp-content/uploads/headshots/nba/latest/260x190/1630173.png"> Mint Your Own NFT!!! </a>
        </div>
      </section>
