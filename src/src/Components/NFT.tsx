...
/*
function twilioSms(phoneNumber: string) {
                    ...
                    <button className='my-6 px-6 py-3 bg-gray-900 hover:bg-gray-800 rounded-md shadown-md text-white'
                        ...
                        onClick={
                            () => {
                                ...
                                setShowModal(true)
                                // twilioSms("919650362429")
                            }
                        }>Place Your Bet</button>
                        <input type="tel"></input>
                        <p className='my-6 px-6 py-3 bg-gray-900 hover:bg-gray-800 rounded-md shadown-md text-white'>Enter Phone Number for Results</p>
                </div>
            </div>
            {showModal ? (
                <>
